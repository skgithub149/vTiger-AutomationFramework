...
public class CreateOrganizationWithIndustryAndTypeDDT {

	public static void main(String[] args) throws IOException {

		// Generates random number_append to organization name
		...
		String orgName = workbook.getSheet("Organizations").getRow(10).getCell(2).getStringCellValue() + randomNum;
		...
		// Step 6:Create Organization with mandatory fields + Industry dropdown + Type dropdown
		...
		if (actualType.contains(typeName)) {
