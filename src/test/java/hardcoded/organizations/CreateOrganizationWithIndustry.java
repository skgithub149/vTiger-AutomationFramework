...
public class CreateOrganizationWithIndustry {
	...
	public static void main(String[] args) {
		...
		// Step 5:Create Organization with mandatory fields + Industry dropdown
		driver.findElement(By.name("accountname")).sendKeys("TataSteel01");
		WebElement industryDropdown = driver.findElement(By.name("industry"));
		Select selectIndustry = new Select(industryDropdown);
		selectIndustry.selectByValue("Chemicals");
		...
		if (orgnanizationHeader.contains("TataSteel01")) {
		...
		if (actualIndustry.contains("Chemicals")) {
